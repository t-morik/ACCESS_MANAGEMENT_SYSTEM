function doGet(e){
  ...
  if(page == "index" || page==null){
    var ssh = SpreadsheetApp.openById('1n__xLdMCpLaZxVGBbQd29Jrt6-FTUjv1EAE8E-pBa88'); //スタンドアローン化したSpreadsheetに接続
    ...
    const sheet = SpreadsheetApp.openById('1n__xLdMCpLaZxVGBbQd29Jrt6-FTUjv1EAE8E-pBa88');//スタンドアローン化したSpreadsheetに接続
...
//以下，テスト関数
function inFunction() {
  const sheet = SpreadsheetApp.openById('1n__xLdMCpLaZxVGBbQd29Jrt6-FTUjv1EAE8E-pBa88');
  value = sheet.getRange('A2').getValue()
  value = value + 1
  new_value = sheet.getRange('B2').setValue(value) 
  const logging = sheet.getRange('A2')
  console.log(logging.getValue());
}
